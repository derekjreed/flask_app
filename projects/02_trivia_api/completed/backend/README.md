...
### Curl
```python
curl -s -X GET http://127.0.0.1:5000/categories
```
...
### Curl
```python
curl -s -X GET http://127.0.0.1:5000/questions
```
...
### Curl
```python
curl -s -X GET http://127.0.0.1:5000/questions?page=1
```
...
### Curl
```python
curl -s -X DELETE http://127.0.0.1:5000/questions/2
```
...
### Curl
```python
curl -s -X POST -H "Content-Type: application/json" -d '{"question": "Which film uses the quote We need a bigger boat?", "answer": "Jaws", "difficulty": "4", "category": "2"}' http://127.0.0.1:5000/questions
```
...
### Curl
```python
curl -s -X POST -H "Content-Type: application/json" --data '{"searchTerm": "beetle"}' http://127.0.0.1:5000/questions/search
```
...
### Curl
```python
curl -s -X GET http://127.0.0.1:5000/categories/1/questions
```
...
```json
{
    ...
    "questions": [
        ...
        {
            "answer": "An ancient sea creature",
            "category": 1,
            "difficulty": 4,
            "id": 29,
            "question": "What is an ammonite?"
        }
    ],
    "success": true,
    "total_questions": 19
...
### Curl
```python
curl -s -X POST -H "Content-Type: application/json" -d '{"previous_questions": [2,4,6,10,11,12], "quiz_category": {"id": 2, "type": "Entertainment"}}' http://127.0.0.1:5000/quizzes
```
...
```json
{
    "question": {
        ...
        "difficulty": 4,
        "id": 30,
        "question": "Which film uses the quote We need a bigger boat?"
    },
    "success": true
}
